  ...
  render() {
    return (
      ...
      <div className="leftNavi">
      	<ul>
      		<li><Link to={this.props.match.url +"/level1"} activeClassName="active">Level 1</Link></li>
      		<li><Link to={this.props.match.url + "/level2"} activeClassName="active">Level 2</Link></li>
      		<li><Link to={this.props.match.url + "/level3"} activeClassName="active">Level 3</Link></li>
      	</ul>
      </div>
