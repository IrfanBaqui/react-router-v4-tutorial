  ...
  render() {
    ...
    return (
      ...
      <div className="leftNavi">
      	<ul>
      		<li><Link activeClassName="active" to={this.props.match.url +"/abc/level1"}>Level 1</Link></li>
      		<li><Link activeClassName="active" to={this.props.match.url + "/level2"}>Level 2</Link></li>
      		<li><Link activeClassName="active" to={this.props.match.url + "/abc/level3"}>Level 3</Link></li>
      	</ul>
      </div>
